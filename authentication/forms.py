...
class Registration_Form(UserCreationForm):
    password1 = forms.CharField(label=_("Password"), widget=forms.PasswordInput(attrs={'class' : '', 'placeholder' : 'Password'}), required=False)
    password2 = forms.CharField(label=_("Confirm Password"), widget=forms.PasswordInput(attrs={'class' : '', 'placeholder' : 'Confirm Password'}), required=False)
